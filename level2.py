...
words_list2 = ['cat', 'dog', 'sun', 'moon', 'tree', 'fish', 'bird', 'star', 'rain', 'snow']
morse_list = [
    '-.-. .- -', 
    '-.. --- --.', 
    '... .. -.', 
...
def start_game(character):
    ...
    screen.bgpic("assets/level2/background.png")
    ...
    demon.goto(190, -130)
    demon.showturtle()
    turtle.addshape(r"assets/level2/monster.gif")
    demon.shape(r"assets/level2/monster.gif")

    demon_atk=turtle.Turtle()
    demon_atk.hideturtle()
    demon_atk.penup()
    demon_atk.goto(demon.pos())
    turtle.addshape(r"assets/level2/monster_atk.gif")
    demon_atk.shape(r"assets/level2/monster_atk.gif")


    def morse(word):
        i=0
        for new_word in words_list2:
            if new_word == word:
                return morse_list[i]
            else:
                i+=1
    ...
    def start_game():
        ...
        while player_life > 0 and demon_life > 0:
            word = random.choice(words_list2)
            encrypted_word = morse(word)  # Reverse the word
            hint_turtle.clear()
