...
words_list3 = ["apple","beach","crane","daisy","eagle","flame","grape","honey","igloo","jolly"]

def start_game(character):
    screen = turtle.Screen()
    screen.setup(600, 600)
    screen.bgpic("assets/level3/background.png")
    ...
    demon.goto(200, -150)
    demon.showturtle()
    turtle.addshape(r"assets/level3/monster.gif")
    demon.shape(r"assets/level3/monster.gif")

    demon_atk=turtle.Turtle()
    demon_atk.hideturtle()
    demon_atk.penup()
    demon_atk.goto(demon.pos())
    turtle.addshape(r"assets/level3/monster_atk.gif")
    demon_atk.shape(r"assets/level3/monster_atk.gif")
    ...
    def start_game():
        ...
        while player_life > 0 and demon_life > 0:
            word = random.choice(words_list3)
            encrypted_word = caeser(word)  # Reverse the word
            hint_turtle.clear()
            hint_turtle.color("white")
            display.color("white")
